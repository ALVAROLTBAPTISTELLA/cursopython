...
"""
from cap08_atividade03Classe import tela, cabecalho, tabCat, tabProd

tela.limparTela()
atividade = input('Informe o nome da atividade.: ')
tela.limparTela()
cabecalho.menucabecalho(atividade)
...
print(dicCategoria)
print(listaProduto)
relatorio = open("./CAP08/relatorio.txt", mode="w", encoding="utf-8")
